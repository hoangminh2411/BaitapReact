    ...
    render() {
        return (
            <div className="container">
                ...
                <Footer bgColor="red" content="FrontEnd"/>
                <Footer bgColor="black" content="BackEnd"/>
                <Footer bgColor="black" content="FullStack"/>
                <Footer bgColor="black" content="Cybersoft"/>
                <Footer bgColor="red" content="123"/>
